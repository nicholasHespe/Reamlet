...
- **Edit annotations after placing them** — select one (click), several (Ctrl/Shift+click, or Shift+drag a box) and change their colour, fill, thickness or, for text, size and style; drag to move them together
